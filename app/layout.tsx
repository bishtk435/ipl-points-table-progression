...
export const metadata: Metadata = {
  title: "IPL Points Table Progression",
  description: "Track the progression of IPL teams throughout the seasons",
};
    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <main className="relative flex min-h-screen flex-col">
          ...
          {/* GitHub Corner Link */}
          <a href="https://github.com/bishtk435/ipl-points-table-progression" target="_blank" rel="noopener noreferrer" className="github-corner" aria-label="View source on GitHub">
